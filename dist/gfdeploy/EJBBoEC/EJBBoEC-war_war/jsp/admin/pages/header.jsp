<%@page contentType="text/html" pageEncoding="UTF-8" errorPage="../pages/examples/404.jsp"%>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Boec Dashboard1</title>
    ...
    <link rel="stylesheet" type="text/css" href="bower_components/jvectormap/jquery-jvectormap.css"/>
    <link rel="stylesheet" type="text/css" type="text/css" href="bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css"/>
