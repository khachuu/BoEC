...
@NamedQueries({
    ...
    , @NamedQuery(name = "Shoes.findByProductsId", query = "SELECT s FROM Shoes s WHERE s.productsId = :productsId")
...
public class Shoes implements Serializable {
    ...
    public Shoes(Integer productsId) {
    ...
    public String toString() {
        return "entities.Shoes[ productsId=" + productsId + " ]";
    }
